...
# Configuration
TOKENIZER_NAME = "meta-llama/Llama-3.2-1B-Instruct"  # Changed to Instruct
MAX_SEQ_LENGTH = 1024  # 1K tokens - matches train_direct.yaml
SHARD_SIZE = 2 * 1024 * 1024 * 1024  # 2GB per shard

# Default Input/Output paths (can be overridden by CLI args)
DEFAULT_INPUT = Path("data/distillation") # Assuming this is where raw JSONL is
DEFAULT_OUTPUT = Path("data/distillation_preprocessed_instruct") # New output dir
